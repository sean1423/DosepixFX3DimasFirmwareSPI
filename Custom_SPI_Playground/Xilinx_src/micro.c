...
#define FX3 1	// Added mainly for DEBUG printing
#if (FX3)
extern unsigned int CyU3PDebugPrint (unsigned char priority, char *message, ... );
#endif
...
#ifdef  DEBUG_MODE
#if (FX3)
	#define XSVFDBG_PRINTF(iDebugLevel,pzFormat) CyU3PDebugPrint(4, pzFormat)
	#define XSVFDBG_PRINTF1(iDebugLevel,pzFormat,arg1) CyU3PDebugPrint(4,pzFormat,arg1)
	#define XSVFDBG_PRINTF2(iDebugLevel,pzFormat,arg1,arg2) CyU3PDebugPrint(4,pzFormat,arg1,arg2)
	#define XSVFDBG_PRINTF3(iDebugLevel,pzFormat,arg1,arg2,arg3) CyU3PDebugPrint(4,pzFormat,arg1,arg2,arg3)
	#define XSVFDBG_PRINTLENVAL(iDebugLevel,plenVal) xsvfPrintLenVal(plenVal)
	#define putchar(x) CyU3PDebugPrint(4, "%c", x)
#else
...
void xsvfPrintLenVal( lenVal *plv )
{
    ...
    if ( plv )
    {
        ...
        {
#if (FX3)
        	CyU3PDebugPrint(4, "%x", ((unsigned int)(plv->val[ i ])) );
#else
...
int xsvfDoXWAIT( SXsvfInfo* pXsvfInfo )
{
    ...
    XSVFDBG_PRINTF2( 3, "   XWAIT:  state = %s; time = %d\n",
...
int xsvfExecute()
{
////	SXsvfInfo   xsvfInfo;	// Moved this to global memory so that it wasn't on the stack
    ...
    if ( xsvfInfo.iErrorCode )
    {
        ...
        XSVFDBG_PRINTF2( 0, "ERROR at or near XSVF command #%d.  See line #%d in the XSVF ASCII file.\n",
...
*****************************************************************************/
#ifdef XSVF_MAIN
#if (0)		// Don't declare main()  John Hyde
