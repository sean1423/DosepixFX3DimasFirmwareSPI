...
//r	GpioConfig.intrMode = CY_U3P_GPIO_NO_INTR;
    ...
    //Status |= CyU3PGpioSetSimpleConfig(TCK, &GpioConfig);
    //Status |= CyU3PGpioSetSimpleConfig(TMS, &GpioConfig);
    //Status |= CyU3PGpioSetSimpleConfig(TDO, &GpioConfig);
    //Status |= CyU3PGpioSetSimpleConfig(TDI, &GpioConfig);
